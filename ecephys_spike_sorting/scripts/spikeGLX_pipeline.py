...
catGT_cmd_string = '-prb_fld -out_prb_fld -aphipass=300 -aplopass=9000 -gbldmx -gfix=0.4,0.10,0.02 -SY=0,384,6,500 -XD=1,0,500 -XA=0,0.4,0,0'
...
event_ex_param_str = 'XA=0,0.4,0,0'
